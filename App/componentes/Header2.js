...
<TouchableOpacity style={h2Styles.tabsList}
  onPress={()=> this.props.go(0) }
     >

<Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60" style={h2Styles.svgTabs}  ><G fill="#FFF">
...
<TouchableOpacity style={h2Styles.tabsListActive}
  onPress={()=> this.props.go(1) }
   >
